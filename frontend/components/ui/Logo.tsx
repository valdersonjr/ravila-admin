/**
 * Logo Ravila's English — SVG inline
 * variant="dark"  → sorriso branco   (para fundos #1A86BE)
 * variant="light" → sorriso azul     (para fundos brancos/claros)
 */
interface LogoProps {
  variant?: "dark" | "light";
  width?: number;
...
export function Logo({ variant = "light", width = 56 }: LogoProps) {
  const smileColor = variant === "dark" ? "#ffffff" : "#1A86BE";
  const height = Math.round(width * (60 / 118));
  ...
  return (
    <svg
      ...
      width={width}
      height={height}
      viewBox="22 70 118 60"
      aria-label="Ravila's English"
    >
      {/* Balão vermelho */}
      <g fill="#e53935" transform="matrix(1.0752885,0,0,1.0893287,-5.0905555,20.600282)">
        <rect width="55.26598" height="39.300247" x="30.70332" y="49.370941" ry="10.901098" />
        <path d="m 85.846485,66.810426 c 0,0 3.684397,46.914674 -18.913247,21.860764" />
      </g>
      {/* Balão azul */}
